...
![Figure 2](images/image-4.png)

* 저자는 Tab. 4 에서 두 metric 을 기준으로 테스트한 모든 LLM 의 순위를 매긴다. 

![Table 4](images/image-5.png)
